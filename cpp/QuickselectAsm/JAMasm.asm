;.386
;.model flat, stdcall									;Wymagane w wersji X86
;.stack 8096
...
;len QWORD 7											;D³ugoœæ tablicy
;numList QWORD 5,3,7,33,1,8,9							;Tablica
;k QWORD 7												;Który element jest do znalezienia
;sortBiggest QWORD 0									;Czy najwiêkszy czy najmniejszy 0 - malej¹co (szuka najmniejszej) 1 - rosn¹co (szuka najwiêklszej)
